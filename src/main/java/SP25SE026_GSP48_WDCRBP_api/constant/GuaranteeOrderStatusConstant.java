...
public class GuaranteeOrderStatusConstant {
    ...
    public static final String DA_DUYET_BAO_GIA = "Đã duyệt báo giá";
    public static final String DANG_CHO_NHAN_HANG = "Đang chờ nhận hàng để sửa chữa";
    public static final String DANG_SUA_CHUA = "Đang sửa chữa";
